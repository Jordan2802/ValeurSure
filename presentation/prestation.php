    ...
    <main>
      ...
      <div class="prestations wow fadeInLeftBig">
        ...
        <div class="form-container  z-depth-3">
          ...
          <div class="form-mobil hide-on-med-and-up">
      ...
      <div class="prestations wow fadeInLeftBig">
        ...
        <div class="info">
          ...
          <div class="info-part">
            <h3>Connaître ma capacité d’emprunt</h3>
            simulateur
          </div>
      ...
      <div class="prestations wow fadeInLeftBig">
        ...
        <div class="info">
          ...
          <div class="info-part">
            ...
            <p>des démarches d’adhésion simplifiées, un seul interlocuteur qui vous donne accès à plusieurs offres et un suivi personnalisé.</p>
          </div>
